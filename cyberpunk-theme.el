...
(let ((class '((class color) (min-colors 89)))
  ...
  ;;; ansi-term
   ...
   `(diredfl-deletion ((,class (:background ,cyberpunk-pink-1 :foreground ,cyberpunk-yellow))))
   `(diredfl-deletion-file-name ((,class (:background ,cyberpunk-pink-2 :foreground ,cyberpunk-yellow))))
